...
// Não cheque essas requisições
				.authorizeRequests().antMatchers("/authenticate", "/v2/api-docs", "/configuration/ui",
						...
						"/h2-console/login.do", "/favicon.ico", "/h2-console/query.jsp",
						"/h2-console/help.jsp", "/api/v1/produto/consulta")
				.permitAll().
// Qualquer outra requisição deve ser checada
	            ...
	            .and().headers().frameOptions().sameOrigin().and().exceptionHandling()
